...
public class Controller {
    ...
    private static final String IS_ADMIN_EXPRESSION = "hasRole('" + Roles.ADMIN + "')";
    private static final String IS_ADMIN_OR_USER_EXPRESSION = "hasAnyRole('" + Roles.ADMIN + "','" + Roles.USER + "')";
    ...
    //TODO documentar nuevas respuestas 401 y 403
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "401", description = "Unauthorized. User is not authorized",
                            content = @Content(schema = @Schema(example = "{\n" +
                                    ...
                                    "  \"status\": 401,\n" +
                                    "  \"error\": \"Unauthorized\",\n" +
                                    "  \"message\": \"Unauthorized. Unauthorized. User is not authorized\",\n" +
                                    "  \"path\": \"/v1/superhero-api\"\n" +
                                    "}"))),
    ...
    @Timed
    @PreAuthorize(IS_ADMIN_OR_USER_EXPRESSION)
    ...
    @Timed
    @PreAuthorize(IS_ADMIN_EXPRESSION)
